...
&lt;ExampleProgram&gt;
&lt;Title&gt;
	&lt;Text Locale="US"&gt;Setup Teardown.lvproj&lt;/Text&gt;
&lt;/Title&gt;
&lt;Keywords&gt;
	&lt;Item&gt;unit&lt;/Item&gt;
	&lt;Item&gt;test&lt;/Item&gt;
...
&lt;/ExampleProgram&gt;</Property>
	<Property Name="NI.Project.Description" Type="Str">Demonstrates how to use setup and teardown VIs to pass values among the setup VI, the VI under test,  and other the teardown VI. This project contains two tests. The Read from File.lvtest test file uses the Open File VI as the setup VI, the Read from File VI as the VI under test, and the Close File VI as the teardown VI. The Write to File.lvtest test file uses the Create File VI as the setup VI, the Write to File VI as the VI under test, and the Close File VI as the teardown VI.</Property>
	...
	<Property Name="utf.run.aggregate.file" Type="Str">C:\Program Files\National Instruments\LabVIEW 8.5\examples\utf\setup teardown\setup teardown.agg</Property>
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="VIs" Type="Folder">
			<Item Name="Setup VI" Type="Folder">
				<Item Name="Create File.vi" Type="VI" URL="../Create File.vi"/>
				<Item Name="Open File.vi" Type="VI" URL="../Open File.vi"/>
			</Item>
			<Item Name="VI Under Test" Type="Folder">
				<Item Name="Write to File.vi" Type="VI" URL="../Write to File.vi"/>
				<Item Name="Read from File.vi" Type="VI" URL="../Read from File.vi"/>
			</Item>
			<Item Name="Teardown VI" Type="Folder">
				<Item Name="Close File.vi" Type="VI" URL="../Close File.vi"/>
			</Item>
		</Item>
		<Item Name="Unit Test Files" Type="Folder">
			<Item Name="Read from File.lvtest" Type="TestItem" URL="../Read from File.lvtest">
				<Property Name="utf.test.bind" Type="Str">Read from File.vi</Property>
				<Property Name="utf.vector.test.bind" Type="Str">24E2F994-F675-61BF-A6BD-61712F9B30D9</Property>
			</Item>
			<Item Name="Write to File.lvtest" Type="TestItem" URL="../Write to File.lvtest">
				<Property Name="utf.test.bind" Type="Str">Write to File.vi</Property>
				<Property Name="utf.vector.test.bind" Type="Str">A1205C5E-0589-DB32-2794-2474D4D74EE5</Property>
			</Item>
		</Item>
